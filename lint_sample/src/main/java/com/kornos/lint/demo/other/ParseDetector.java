 ...
 * 防止类型转换出错
 */
public class ParseDetector extends Detector implements Detector.UastScanner {
    public static Issue ISSUE = Issue.create("ParseStandard",
            "parse方法使用规范",
            "parse方法需要加try catch",
            Category.SECURITY, 6, Severity.ERROR,
            new Implementation(ParseDetector.class, Scope.JAVA_FILE_SCOPE)).addMoreInfo("https://github.com/liulingfeng/lint");
